...
The tracks below break that prompt into focused challenges. They are
directions, not assignments — strong contributions can also sit between
tracks or outside them entirely. All work uses synthetic data
(`synthetic-data/datasets/`) or documented aggregate assumptions.
